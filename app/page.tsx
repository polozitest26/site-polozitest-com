        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              className="bg-gradient-to-r from-success-600 to-success-700 text-white px-6 py-2.5 rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300 font-semibold"
            >
              Prijavi se
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 italic">
                "Položio sam iz prvog pokušaja zahvaljujući ovom portalu! AI algoritam je prepoznao moje slabe tačke i prilagodio mi testove. Za mesec dana sam bio spreman i prošao bez problema. Preporučujem svima!"
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 italic">
                "Odlična statistika koja mi je pokazala tačno gde grešim! Nisam gubila vreme na pitanja koja već znam, već sam se fokusirala na problematične oblasti. Portal je jednostavan za korišćenje i vrlo intuitivan."
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 italic">
                "Kao neko ko radi ceo dan, ovaj portal mi je omogućio da učim kad god imam vremena. Simulacije ispita su mi dale veliku sigurnost i znao sam šta da očekujem na pravom testu. Sve pohvale!"
              </p>
            </motion.div>
          </div>
        </div>
