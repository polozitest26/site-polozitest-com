        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              {/* Slide 1 */}
              <SwiperSlide>
                <div className="relative aspect-[478/428] rounded-3xl overflow-hidden shadow-2xl border-4 border-white hover:scale-105 transition-transform duration-300 bg-gray-100">
                  <Image
